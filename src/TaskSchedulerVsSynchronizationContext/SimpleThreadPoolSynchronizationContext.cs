...
internal class SimpleThreadPoolSynchronizationContext : SynchronizationContext
{
    ...
    {
        WriteLine($"Post from SimpleThreadPoolSynchronizationContext in {Thread.CurrentThread.ManagedThreadId}");
    ...
    //{
    //    WriteLine($"Send from SimpleThreadPoolSynchronizationContext in {Thread.CurrentThread.ManagedThreadId}");
    //    d.Invoke(state);
    //}
}